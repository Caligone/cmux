...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate, CmuxConfigStoreReloadEnvironment {
    ...
    func sortedMainWindowContextsForSessionSnapshot(includeQuickTerminal: Bool = true) -> [MainWindowContext] {
    ...
    private func buildSessionSnapshotResult(
        ...
        for context in regularContexts {
        ...
        guard !windowsWithPendingQuickTerminal.isEmpty else {
            return (nil, removedCrashDiagnosticState)
        }
